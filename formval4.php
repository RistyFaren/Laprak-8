...
<body>
    <div class="textcenter">
        ...
        <table>
                <tr><td>Nama Ibu Kandung </td><td><input type="text" name="namaibu"></td></tr>
                <tr><td>Tahun Lahir         </td><td><input type="text" name="thnlahiribu"></td></tr>
                <tr><td>Pendidikan </td><td>
                    <select name="pendidikanibu">
